...
export const tasks = pgTable('tasks', {
  ...
  clientLogs: jsonb('client_logs').$type<LogEntry[]>(),
  serverLogs: jsonb('server_logs').$type<LogEntry[]>(),
  error: text('error'),
...
export const insertTaskSchema = z.object({
  ...
  clientLogs: z.array(logEntrySchema).optional(),
  serverLogs: z.array(logEntrySchema).optional(),
...
export const selectTaskSchema = z.object({
  ...
  clientLogs: z.array(logEntrySchema).nullable(),
  serverLogs: z.array(logEntrySchema).nullable(),
